    ...
    $.ajax({
        ...
        success:function(response){
            ...
            for(var i = 0 ; i < response.length ; i++ ){
                var dat = response[i];
                record.append("<div class='prod' data-id= " + dat._id + " >I am <h4>" + dat.name + "</h4> and my price is <h4>" + dat.price + "</h4> i am <h4>" + dat.color + "</h4> in color. My department is <h4>" + dat.department + "</h4>. <br/> <h5> Description: </h5>" + dat.description + " </div>");
            }
        }
    });
}
...
function mouseUp(){
    ...
    $.ajax({
        url:"https://usman-recipes.herokuapp.com/api/products/"+$(this).attr("data-id"),
        method:"GET",
        success:function(response){
